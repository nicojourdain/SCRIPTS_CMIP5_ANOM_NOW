...
vars2d_codes={'dew':168,'tas':167,'uas':165,'vas':166,'ps':134,'psl':151,'ts':34}
...
for y in range(nyears):
  ...
  for month in range(1,13):
    ...
    date_end  = dt.datetime(year,month,calendar.monthrange(year, month)[1],18)
